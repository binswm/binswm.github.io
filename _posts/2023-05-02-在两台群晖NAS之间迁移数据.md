...
| <br>迁移的项目&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; | 数据（存储空间和块级 LUN）、所有套件和大多数系统配置         | 数据、所有套件和大多数系统配置                               | 所选数据、所选套件以及配置备份支持的系统配置                 |
...
| <br>从\到 &emsp;&emsp;&emsp;&emsp;  | <br>群组 1 &emsp;&emsp;&emsp;&emsp; | 群组 2                                                       | 群组 3                                                       |
| :----- | :----- | :----------------------------------------------------------- | :----------------------------------------------------------- |
