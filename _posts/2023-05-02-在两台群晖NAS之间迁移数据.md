...
| <br>使用情形 &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; | 如果您希望使用新硬盘和目的地 NAS                             | 如果来源 NAS 损毁[2](https://kb.synology.cn/zh-cn/DSM/tutorial/How_to_migrate_between_Synology_NAS_DSM_6_0_and_later#x_anchor_id50)如果您希望继续使用相同硬盘如果您希望迁移硬盘而不考虑型号限制 | 如果您希望在目的地 NAS 上使用新文件系统如果其他两种方法不合适 |
